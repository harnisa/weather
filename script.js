...
Weather.prototype.getLocation = function () {
  ...
  var res = { "city": "Kuala Lumpur", "country": "Malaysia", "countryCode": "MY", "query": "200.61.38.44", "regionName": "Kuala Lumpur MY", "status": "success" };
...
Weather.prototype.currentWeather = function () {
  ...
  if (this.location) {
    ...
    $.getJSON("https://api.openweathermap.org/data/2.5/weather", { q: this.location, units: "metric", appid: "ae1a5729bea7ac3a3e1c705ca581413d" }, function (json) {
...
Weather.prototype.forecast = function () {
  ...
  function displayForecast() {
    ...
    _this = this;
    $(".days-box").children(".day-card").each(function (index) {
